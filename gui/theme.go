//go:generate fyne bundle -o bundled.go Resources/Images/KrankyBearBeanieMultiColor.png
//go:generate fyne bundle -o bundled.go -a Resources/Images/KrankyBearBeanieMultiColor64.png
